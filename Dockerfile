...
ARG TEMBO_SHARE_DIR=${TEMBO_VOLUME}/${PG_MAJOR}/share
ARG TEMBO_PG_LIB_DIR=${TEMBO_VOLUME}/${PG_MAJOR}/lib
ARG TEMBO_LD_LIB_DIR=${TEMBO_VOLUME}/${UBUNTU_NAME}/lib
...
RUN set -xe; \
    ...
    # Stash away sharedir so the Tembo operator can copy it back when it
    # initializes the pod. (We should be able to do it during pod initialization
    # without a temp copy: https://stackoverflow.com/a/72269316/79202)
